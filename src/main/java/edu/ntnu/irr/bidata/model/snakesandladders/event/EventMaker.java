 ...
 *
 * <p>Provides static methods to create predefined events like ladders and quiz tiles.
 */
public class EventMaker {
   ...
   *
   * <p>Retrieves a random question and answer from the FileHandler to populate the event.
   *
