 ...
 *
 * <p>This class uses Jackson annotations to support polymorphic deserialization. It allows the
 * system to dynamically determine the specific subclass of an event during JSON (de)serialization
 * based on the "@class" property.
 *
 * <p>I used Chat GTP to find out how i shold use the Jackson libery to suport polymorphic
 * deserialization, and i based the JasonTypeInfo and JsonSubTypes on code generated by chat GTP
 *
 * <p>Known subclasses:
 *
 * <ul>
