 ...
 * <p>
 * When a player lands on this tile, they must answer a question. If the answer is correct,
 * they move forward 3 tiles; if incorrect, they move back 3 tiles.
 */
public class QuizEvent extends Event {
     ...
     * <p>
     * Required for JSON serialization/deserialization frameworks like Jackson.
     */
    public QuizEvent() {
     ...
     * <p>
     * If the player answers correctly via a pop-up, they move forward 3 tiles.
     * Otherwise, they move back 3 tiles.
     *
