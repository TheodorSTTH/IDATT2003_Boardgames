...
import edu.ntnu.irr.bidata.view.snakesandladders.DieView;
...
public class AttackPaneController extends AbstractSidebarPaneController implements
    Observer<Pair<Dice, Dice>> {
